  ...
  public:
	...
	virtual void End()      
	{
		...
		for (int i = 0; i < NUMBER_USED_PIXELS; i++)
			_pStrip->setPixelColor(i, COLOR_DARK_RED);		//I use dark red here to act as a basic park light that is always on
		_pStrip->show();									//If you don't want or need this funtionality set color to black.
	};
...
// COLOR ARRAY FOR A TOW TRUCK/SAFETY VEHICLE  STYLE LIGHT BAR
 const PoliceLightBarState PoliceLightBar::_PoliceBarStates1[] =
 {
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   }, 200 },
 	{  { COLOR_AMBER,  COLOR_AMBER,  COLOR_BLACK,   COLOR_BLACK,   COLOR_AMBER,  COLOR_AMBER,  COLOR_BLACK,   COLOR_BLACK   }, 200 },
 	{  { COLOR_WHITE,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   },  20 },
 	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_WHITE   },  20 },
	{  { COLOR_BLACK,  COLOR_WHITE,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   },  20 },	
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_WHITE,   COLOR_AMBER   },  20 },
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_WHITE,   COLOR_AMBER,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   },  20 },
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_BLACK,  COLOR_WHITE,  COLOR_AMBER,   COLOR_AMBER   },  20 },
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_WHITE,   COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   },  20 },
	{  { COLOR_BLACK,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER,   COLOR_WHITE,  COLOR_BLACK,  COLOR_AMBER,   COLOR_AMBER   },  20 },
	{  { COLOR_AMBER,  COLOR_AMBER,  COLOR_BLACK,   COLOR_BLACK,   COLOR_AMBER,  COLOR_AMBER,  COLOR_BLACK,   COLOR_BLACK   }, 200 },
};

// COLOR ARRAY FOR POLICE STYLE LIGHT BAR
// const PoliceLightBarState PoliceLightBar::_PoliceBarStates1[] =
//  {
